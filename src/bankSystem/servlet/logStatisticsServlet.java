...
/**
 * Servlet implementation class logStatisticsServlet
 */
@WebServlet("/logStatisticsServlet")
public class logStatisticsServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public logStatisticsServlet() {
        super();
